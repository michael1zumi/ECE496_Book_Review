...
import static edu.sfsu.cs.orange.ocr.R.id.ocr_continuous_decode_failed;
import static edu.sfsu.cs.orange.ocr.R.id.restart_preview;
...
final class CaptureActivityHandler extends Handler {
  ...
  public void handleMessage(Message message) {
    ...
    } else if (message.what == ocr_continuous_decode_failed) {
  ...
  void stop() {
    ...
    removeMessages(ocr_continuous_decode_failed);
