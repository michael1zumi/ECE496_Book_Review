...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback, 
  ...
  public void onCreate(Bundle icicle) {
    ...
    //toast = Toast.makeText(this, "uuuuuu!!!", Toast.LENGTH_LONG);
    System.out.println("Hello in OCRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR");
    System.out.println("Hello in OCRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR");
    System.out.println("Hello in OCRRRRRRRRRRRRRRRRRRRRRRRRRRRRRR");
  ...
  boolean handleOcrDecode(OcrResult ocrResult) {
    ...
    Toast toast = Toast.makeText(this, "return intent!!!", Toast.LENGTH_LONG);
    System.out.println("aaaaaaaaaaa return ha aaaaaaaaaaaaaaaaaaaaaaaaaaa");
    Intent resultIntent = new Intent();
    resultIntent.putExtra("returnedLibString", ocrResult.getText());
